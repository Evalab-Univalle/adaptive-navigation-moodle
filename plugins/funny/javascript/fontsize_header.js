...
YUI().use('node','stylesheet', function (Y) {
    ...
    if(cookie_myhome_layout == 1){
        // update layout
        new Y.StyleSheet("#page #region-main .block { float: none; height: "+cookie_myhome_height+"; width: auto; }");
    }else if(cookie_myhome_layout == 2){
        // update layout
        new Y.StyleSheet("#page #region-main .block { float: left; width: 48.5%; height: "+cookie_myhome_height+"; margin-right: 1%}");
    }else if(cookie_myhome_layout == 3){
        // update layout
        new Y.StyleSheet("#page #region-main .block { float: left; width: 31.5%; height: "+cookie_myhome_height+"; margin-right: 1%}");
    }else if(cookie_myhome_layout == 4){
        // update layout
        new Y.StyleSheet("#page #region-main .block { float: left; width: 23.5%; height: "+cookie_myhome_height+"; margin-right: 1%}");
    }
});