...
?>
    <div id="da-slider" class="da-slider <?php echo $hideonphone; ?> variant<?php echo $PAGE->theme->settings->slideshowvariant;?>" style="background-position: 8650% 0%;">
    ...
    <?php } ?>
      ...
      <?php if ($hasslide5) { ?>
        <div class="da-slide">
            ...
            <?php } ?>
            <?php if ($hasslide5url) { ?>
                <a href="<?php echo $slide5url ?>" class="da-link"><?php echo get_string('readmore','theme_essential')?></a>
            <?php } ?>
