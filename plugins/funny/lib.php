 ...
 */
function theme_funny_set_fontwww($css) {
    global $CFG, $PAGE;
 ...
 */
function theme_funny_set_logo($css, $logo) {
    global $OUTPUT;
    $tag = '[[setting:logo]]';
    $replacement = $logo;
 ...
 * @return string The parsed CSS
 */
function theme_funny_set_secondlogo($css, $secondlogo) {
    global $OUTPUT;
    $tag = '[[setting:secondarylogo]]';
    $replacement = $secondlogo;
    if (is_null($replacement)) {
        $replacement = '';
    }
    $css = str_replace($tag, $replacement, $css);
...
function theme_funny_set_mainblockbackgroundlogo($css, $logo) {
    global $OUTPUT;
    $tag = '[[setting:mainblockbackground]]';
    $replacement = $logo;
    if (is_null($replacement)) {
        $replacement = '';
    }
 ...
 * @return bool
 */
function theme_funny_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM) {
        $theme = theme_config::load('funny');
        if ($filearea === 'logo') {
            return $theme->setting_file_serve('logo', $args, $forcedownload, $options);
        }else if ($filearea === 'secondarylogo') {
            return $theme->setting_file_serve('secondlogo', $args, $forcedownload, $options);
        } else if ($filearea === 'pagebackground') {
            return $theme->setting_file_serve('pagebackground', $args, $forcedownload, $options);
        } else if ($filearea === 'mainblockbackground') {
            return $theme->setting_file_serve('mainblockbackground', $args, $forcedownload, $options);
        } else if ((substr($filearea, 0, 5) === 'slide') && (substr($filearea, 6, 5) === 'image')) {
            return $theme->setting_file_serve($filearea, $args, $forcedownload, $options);
        } else if ((substr($filearea, 0, 10) === 'blockimage')) {
            return $theme->setting_file_serve($filearea, $args, $forcedownload, $options);
 ...
 * @return string
 */
function funny_set_pagewidth($css, $pagewidth) {
 ...
 * @return string
 */
function funny_set_maxwidth($css, $maxwidth) {
    $tag = '[[setting:maxwidth]]';
    $replacement = $maxwidth;
    if (is_null($replacement)) {
        $replacement = '1200';
    }
    if ( $replacement == "100" ) {
 ...
 * @return string
 */
function funny_set_editicons($css, $editicons) {
	global $CFG;
	if (!empty($CFG->themedir)) {
		$editiconsurl = $CFG->themedir . '/funny/style/editicons.css'; //Pull the full path for autohide css
	} else {
		$editiconsurl = $CFG->dirroot . '/theme/funny/style/editicons.css'; //MDL-36065
	}
 ...
 * @return string
 */
function funny_performance_output($param) {
 ...
 */
function funny_set_customcss($css, $customcss) {
...
function theme_funny_process_css($css, $theme) {
    ...
    $css = funny_set_pagewidth($css,$pagewidth);
	
	if (!empty($theme->settings->maxwidth)) {
       $maxwidth = $theme->settings->maxwidth;
    } else {
       $maxwidth = null;
    }
    $css = funny_set_maxwidth($css,$maxwidth);
    ...
    $css = theme_funny_set_headingfont($css, $headingfont);
    $css = theme_funny_set_bodyfont($css, $bodyfont);
    $css = theme_funny_set_bodysize($css, $bodysize);
    $css = theme_funny_set_bodyweight($css, $bodyweight);
    ...
    $css = theme_funny_set_themecolor($css, $themecolor);
    ...
    $css = theme_funny_set_themehovercolor($css, $themehovercolor);
    ...
    $css = theme_funny_set_footercolor($css, $footercolor);
    ...
    $css = theme_funny_set_footersepcolor($css, $footersepcolor);
    ...
    $css = theme_funny_set_footertextcolor($css, $footertextcolor);
    ...
    $css = theme_funny_set_footerurlcolor($css, $footerurlcolor);
    ...
    $css = theme_funny_set_footerhovercolor($css, $footerhovercolor);
...
// Set the footer heading color.
    ...
    $css = theme_funny_set_footerheadingcolor($css, $footerheadingcolor);
    ...
    $css = theme_funny_set_slideheadercolor($css, $slideheadercolor);
    ...
    $css = theme_funny_set_slidecolor($css, $slidecolor);
    ...
    $css = theme_funny_set_slidebuttoncolor($css, $slidebuttoncolor);
    ...
    foreach (range(1, 3) as $alternativethemenumber) {
        ...
        $css = theme_funny_set_alternativecolor($css, 'color' . $alternativethemenumber, $theme->settings->{'alternativethemecolor' . $alternativethemenumber}, $default);
        $css = theme_funny_set_alternativecolor($css, 'hovercolor' . $alternativethemenumber, $theme->settings->{'alternativethemehovercolor' . $alternativethemenumber}, $defaulthover);
    }
    ...
    $css = theme_funny_set_navbarsep($css, $navbarsep);
    ...
    $css = funny_set_editicons($css, $editicons);
    ...
    $css = funny_set_customcss($css, $customcss);

    // Set the background image for the logo.
    $logo = $theme->setting_file_url('logo', 'logo');
    $css = theme_funny_set_logo($css, $logo);
	
	// Set the background image for the logo.
    $secondlogo = $theme->setting_file_url('secondarylogo', 'secondarylogo');
    $css = theme_funny_set_secondlogo($css, $secondlogo);
    
    // Set the background image for the page.
    $setting = 'pagebackground';
    $pagebackground = $theme->setting_file_url($setting, $setting);
    $css = theme_funny_set_pagebackground($css, $pagebackground, $setting);
    ...
    $css = theme_funny_set_defaultcategoryicon($css, $defaultcategoryicon);
    ...
    foreach (range(1, 20) as $categorynumber) {
        ...
        $css = theme_funny_set_categoryicon($css, $categoryicon, $categorynumber);
    }
    ...
    $css = theme_funny_set_slideimage($css, $slideimage, $setting);
    ...
    // Set the background image for the main page block
    $mainblockbackground = $theme->setting_file_url('mainblockbackground', 'mainblockbackground');
    $css = theme_funny_set_mainblockbackgroundlogo($css, $mainblockbackground);

    // Set the font path.

    $css = theme_funny_set_fontwww($css);
    return $css;
}
 ...
 */
function theme_funny_initialise_colourswitcher(moodle_page $page) {
    user_preference_allow_ajax_update('theme_funny_colours', PARAM_ALPHANUM);
    $page->requires->yui_module(
        'moodle-theme_funny-coloursswitcher',
        'M.theme_funny.initColoursSwitcher',
 ...
 */
function theme_funny_get_colours($default = 'default') {
    $theme = theme_config::load('funny');
    $preference = get_user_preferences('theme_funny_colours', $default);
    foreach (range(1, 3) as $alternativethemenumber) {
 ...
 */
function theme_funny_check_colours_switch() {
    $colours= optional_param('funnycolours', null, PARAM_ALPHANUM);
    if (in_array($colours, array('default', 'alternative1', 'alternative2', 'alternative3'))) {
        set_user_preference('theme_funny_colours', $colours);
    }
}

 
function theme_funny_set_headingfont($css, $headingfont) {
...
function theme_funny_set_bodyfont($css, $bodyfont) {
...
function theme_funny_set_bodysize($css, $bodysize) {
...
function theme_funny_set_bodyweight($css, $bodyweight) {
...
function theme_funny_set_themecolor($css, $themecolor) {
...
function theme_funny_set_themehovercolor($css, $themehovercolor) {
...
function theme_funny_set_alternativecolor($css, $type, $customcolor, $defaultcolor) {
...
function theme_funny_set_footercolor($css, $footercolor) {
...
function theme_funny_set_footertextcolor($css, $footertextcolor) {
...
function theme_funny_set_footerurlcolor($css, $footerurlcolor) {
...
function theme_funny_set_footerhovercolor($css, $footerhovercolor) {
...
function theme_funny_set_footerheadingcolor($css, $footerheadingcolor) {
...
function theme_funny_set_slideheadercolor($css, $slideheadercolor) {
...
function theme_funny_set_slidecolor($css, $slidecolor) {
...
function theme_funny_set_slidebuttoncolor($css, $slidebuttoncolor) {
...
function theme_funny_set_footersepcolor($css, $footersepcolor) {
...
function theme_funny_set_navbarsep($css, $navbarsep) {
...
function theme_funny_set_pagebackground($css, $pagebackground, $setting) {
    global $OUTPUT;
...
function theme_funny_set_slideimage($css, $slideimage, $setting) {
    global $OUTPUT;
    $tag = '[[setting:'.$setting.']]';
...
function theme_funny_set_helpimage($css, $helpimage, $setting) {
    global $OUTPUT;
    $tag = '[[setting:'.$setting.']]';
    $replacement = $helpimage;
    $css = str_replace($tag, $replacement, $css);
    return $css;
}


function theme_funny_set_defaultcategoryicon($css, $defaultcategoryicon) {
...
function theme_funny_set_categoryicon($css, $categoryicon, $categorynumber) {
...
function theme_funny_page_init(moodle_page $page) {
    $page->requires->jquery();
    $page->requires->jquery_plugin('cslider', 'theme_funny');
    $page->requires->jquery_plugin('custom', 'theme_funny'); 
    $page->requires->jquery_plugin('alert', 'theme_funny');
    $page->requires->jquery_plugin('carousel', 'theme_funny');
    $page->requires->jquery_plugin('collapse', 'theme_funny');
    $page->requires->jquery_plugin('modal', 'theme_funny');
    $page->requires->jquery_plugin('scrollspy', 'theme_funny');
    $page->requires->jquery_plugin('tab', 'theme_funny');
    $page->requires->jquery_plugin('tooltip', 'theme_funny');
    $page->requires->jquery_plugin('transition', 'theme_funny');
    $page->requires->jquery_plugin('modernizr', 'theme_funny');  
}